...
`hs-cli` ships with a [`SKILL.md`](./SKILL.md) that Claude Code (and compatible agents) can load to use the CLI intelligently. Drop the file under `.claude/skills/hearthstone-deck/` and the agent will pick it up.
